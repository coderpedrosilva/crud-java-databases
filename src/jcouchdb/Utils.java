...
public class Utils {
	...
	public static HttpClient conectar() {
		...
		HttpClient conn = HttpClient.newBuilder().version(HttpClient.Version.HTTP_2).build();
	...
	public static void inserir() {
		...
		HttpRequest requisicao = HttpRequest.newBuilder().uri(URI.create(link))
				.POST(BodyPublishers.ofString(nproduto.toString())).header("Content-Type", "application/json").build();
		try {
			HttpResponse<String> resposta = conn.send(requisicao, BodyHandlers.ofString());
	...
	public static void atualizar() {
		...
		HttpRequest requisicao = HttpRequest.newBuilder().uri(URI.create(link))
				.PUT(BodyPublishers.ofString(nproduto.toString())).header("Content-Type", "application/json").build();
